...
const UsdtHistory = () => {
	...
	return (
		<div className="h-full w-full bg-bg-red bg-cover p-4 pb-7 text-white">
			<div className="ml-3 flex pt-2">
				<ChevronLeft onClick={clickBack} />
				<span className="ml-5">Sundog History</span>
			</div>
			<div className="relative">
				<img
					src="/img/red-history-border.png"
				...
				<div className="no-scrollbar relative h-[calc(100vh-114px)] overflow-y-auto px-6">
					{filterDate.map((item, index) => (
						...
						>
							<div className="flex">
								<img className="h-12 w-12" src="/img/SUNDOG-token.png" />
								<div className="ml-3">
