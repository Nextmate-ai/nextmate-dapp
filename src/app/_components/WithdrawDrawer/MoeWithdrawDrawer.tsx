...
const WithdrawDrawer: React.FC<WithdrawDrawerProps> = ({ isOpen, onClose }) => {
	...
	const handleConfirm = async () => {
		...
		const claimData = await fetchClaimData(MOE_ADDR);
	...
	return (
		<>
			{visible && (
				...
				>
					<div
						className={`flex h-screen w-full transform flex-col items-center justify-start bg-white bg-bg-gray bg-cover px-3 transition-transform duration-300 sm:max-w-[520px] ${
					...
					>
						...
						<div className="relative mb-5 mt-8 flex h-[120px] w-full items-center justify-center bg-gray-balance-panel bg-[length:100%_100%] bg-no-repeat">
							<Link
								href={'/withdraw/moe'}
								onClick={clickRouter}
							...
							<div className="flex items-center justify-center gap-4">
								<img className="h-12 w-12" src="/img/Moe-token.png" alt="moe" />
